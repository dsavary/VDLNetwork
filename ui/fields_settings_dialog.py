...
class FieldsSettingsDialog(QDialog):
    ...
    def __init__(self):
        ...
        self.setWindowTitle(QCoreApplication.translate("VDLNetwork", "Memory lines layer fields"))

        self.resize(400, 200)
        self.__layout = QGridLayout()

        titleLabel = QLabel(QCoreApplication.translate("VDLNetwork", "One or more fields needed are missing in the memory lines layer."))
        titleLabel.setMinimumHeight(20)
        titleLabel.setMinimumWidth(50)
        self.__layout.addWidget(titleLabel, 0, 0)

        subtitleLabel = QLabel(QCoreApplication.translate("VDLNetwork", "You want to : "))
        subtitleLabel.setMinimumHeight(20)
        subtitleLabel.setMinimumWidth(50)
        self.__layout.addWidget(subtitleLabel, 1, 0)

        self.__okButton = QPushButton(QCoreApplication.translate("VDLNetwork", "Add the needed fields in the layer and use it"))
        self.__okButton.setMinimumHeight(20)
        self.__okButton.setMinimumWidth(100)
        self.__layout.addWidget(self.__okButton, 2, 0)

        self.__butButton = QPushButton(QCoreApplication.translate("VDLNetwork", "Use it without those fields"))
        self.__butButton.setMinimumHeight(20)
        self.__butButton.setMinimumWidth(100)
        self.__layout.addWidget(self.__butButton, 3, 0)

        self.__cancelButton = QPushButton(QCoreApplication.translate("VDLNetwork", "Cancel"))
